...
const data: Checklist = {
    ...
    items: [
        ...
        { key: 'leveling-drustvar', name: 'Drustvar', type: 'header', level: 1 },
        ...
        { key: 'leveling-stormsong', name: 'Stormsong Valley', type: 'header', level: 1 },
        ...
        { key: 'leveling-tiragarde', name: 'Tiragarde Sound', type: 'header', level: 1 },
        ...
        { key: 'wareffort-anationunited', name: 'A Nation United', type: 'header', level: 1 },
        ...
        { key: 'ship-upgrades-tier6', name: 'Tier 6 (Alliance Ambassador)', type: 'manual' },

        { key: 'ship-falstad', name: 'Follower: Falstad Wildhammer', type: 'header', level: 1 },
        { key: 'ship-falstad-collected', name: 'Collected', type: 'quest', id: 51714 },
        { key: 'ship-falstad-upgraded', name: 'Legendary Quality', type: 'manual' },

        { key: 'ship-keeshan', name: 'Follower: John J. Keeshan', type: 'header', level: 1 },
        { key: 'ship-keeshan-collected', name: 'Collected', type: 'quest', id: 52013 },
        { key: 'ship-keeshan-upgraded', name: 'Legendary Quality', type: 'manual' },

        { key: 'ship-kelsey', name: 'Follower: Kelsey Steelspark', type: 'header', level: 1 },
        { key: 'ship-kelsey-collected', name: 'Collected', type: 'quest', id: 52003 },
        { key: 'ship-kelsey-upgraded', name: 'Legendary Quality', type: 'manual' },

        { key: 'ship-umbric', name: 'Follower: Magister Umbric', type: 'header', level: 1 },
        { key: 'ship-umbric-collected', name: 'Collected', type: 'quest', id: 52008 },
        { key: 'ship-umbric-upgraded', name: 'Legendary Quality', type: 'manual' },

        { key: 'ship-shandris', name: 'Follower: Shandris Feathermoon', type: 'header', level: 1 },
        { key: 'ship-shandris-collected', name: 'Collected', type: 'quest', id: 53098 },
        { key: 'ship-shandris-upgraded', name: 'Legendary Quality', type: 'manual' },

        { key: 'ship-jestereth', name: 'Follower: Grand Admiral Jes-Tereth', type: 'header', level: 1 },
        { key: 'ship-jestereth-collected', name: 'Collected', type: 'quest', id: 56378 },
        { key: 'ship-jestereth-upgraded', name: 'Legendary Quality', type: 'manual' },
    ],
};
